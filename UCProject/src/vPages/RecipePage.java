...
public class RecipePage {
	...
	public void CreateSOAPRecipe(String RecipeName, String MapName) {
...
//			-------------HH---HH-----TT--------TT-----PP-----------------
	...
	public void CreateHTTPRecipe(String RecipeName,String ConnectionFile, String OperationFile, String MapName) throws InterruptedException {
...
//			}
	...
	//			------------------Configuration HTTP Client----------------------------
				...
				inpFileName.sendKeys(ConnectionFile);
				
				Thread.sleep(4000);
				
				if(selectFileConfig.getText().contains(ConnectionFile)) {
				...
				inpFileName2.sendKeys(OperationFile);
				
				Thread.sleep(4000);
				
				if(selectFileConfig.getText().contains(OperationFile)) {
